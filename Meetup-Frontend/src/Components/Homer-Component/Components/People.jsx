...
export const People = ({type}) => {
    ...
    return (
        <div className='border-2 border-slate-500 lg:h-[450px]  rounded-lg p-3 overflow-y-scroll'>
            ...
            <div className='space-y-2 cursor-pointer rounded-lg'>
                <section className="flex space-x-2 items-center  rounded-md   hover:bg-purple-700 hover:text-gray-200">
                    ...
                    <div>
                        <p className="text-lg font-semibold">Sohanur Rahman Abir  {type=='online'? (<span className="text-green-600 text-sm">&#9679;</span>) : addFreind } </p>
